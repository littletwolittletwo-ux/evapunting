          ...
          <div className="bg-amber-50 border border-amber-200 rounded-xl p-6 mb-6">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h2 className="text-lg font-semibold text-amber-800">Outstanding Balance</h2>
              ...
              <button
                ...
                disabled={payingDebt}
                className="px-6 py-3 rounded-lg font-medium text-white bg-amber-600 hover:bg-amber-700 disabled:opacity-50 transition-colors flex-shrink-0"
              >
          ...
          {hasPaymentMethod && !showCardForm && (
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-medium text-gray-900">{paymentMethodDisplay}</p>
            ...
            <div className="mt-4 space-y-4">
              ...
              <div className="flex gap-3">
                <button
                  ...
                  className="px-6 py-3 rounded-lg font-medium text-white bg-blue-600 hover:bg-blue-700 disabled:opacity-50 transition-colors"
                >
                  {cardFormLoading ? 'Saving...' : 'Save Card'}
                </button>
                <button
                  onClick={handleCancelCardForm}
                  className="px-6 py-3 rounded-lg border border-gray-300 text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors"
                >
                  Cancel
                </button>
              </div>
        ...
        <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-200 mb-6">
          ...
          >
            <div className="flex items-center gap-2">
              ...
              <h2 className="text-xl font-bold text-gray-900">Token Summary</h2>
            </div>
            {summaryExpanded ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
              <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                <div className="flex items-center justify-between mb-2">
                  <span className="text-sm font-medium text-gray-500">Current Token Balance</span>
              ...
              <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                <div className="flex items-center justify-between mb-2">
                  <span className="text-sm font-medium text-gray-500">Lifetime Tokens Charged</span>
              ...
              <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                <div className="flex items-center justify-between mb-2">
                  <span className="text-sm font-medium text-gray-500">Current Week Debt</span>
                  <AlertTriangle className="h-4 w-4 text-amber-600" />
                </div>
                <p className={`text-2xl font-bold ${currentWeekDebt > 0 ? 'text-amber-600' : 'text-gray-900'}`}>
            ...
            <>
              {billingCycles.length === 0 ? (
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-500">No billing cycles yet.</p>
                  ...
                  <table className="w-full text-sm">
                    <thead>
                      <tr className="border-b border-gray-200">
                        <th className="text-left py-3 px-3 font-semibold text-gray-500">Week</th>
                        <th className="text-right py-3 px-3 font-semibold text-gray-500">Gross Profit</th>
                        <th className="text-right py-3 px-3 font-semibold text-gray-500">Tokens</th>
                        <th className="text-right py-3 px-3 font-semibold text-gray-500">Amount AUD</th>
                        <th className="text-center py-3 px-3 font-semibold text-gray-500">Status</th>
                        <th className="text-right py-3 px-3 font-semibold text-gray-500">Date Paid</th>
                      </tr>
                    </thead>
                    <tbody>
